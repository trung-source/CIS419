...
def plotData1D( X, y, to_block = True,str="DATA"):
    '''
...
def plotRegLine1D( lr_model, X, y,string="DATA"):
    '''
    ...
    '''
    plotData1D(X[:,1], y, to_block =False,str=string)
    # plt.hold(True)
...
if __name__ == "__main__":
    ...
    plotData1D(X[:,1],y,str = "Univariate Data")
    lr_model.fit(X,y)
    # print("x",X.shape,"y",y.shape)
    # print("theta",lr_model.theta.shape)
    plotRegLine1D(lr_model,X, y,string = "Univariate Data")
